...
program
    ...
    .action(function () {
        ...
        list
            .option('  Expo App (typescript) with Storybook ', TYPE_OF_APP.REACT_NATIVE_STORYBOOK)
            .list();
            ...
            inquirer
                ...
                .then((answer) => {
                    ...
                    switch (options[0].value) {
                        case TYPE_OF_APP.REACT_NATIVE_STORYBOOK:
                            template =
                    ...
                    spinner.start();
                    if (options[0].value === TYPE_OF_APP.REACT_NATIVE_STORYBOOK) {
